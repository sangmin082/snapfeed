  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-10">
      <div className="flex flex-col gap-6">
        <Link href="/" className="mx-auto text-2xl font-bold tracking-tight text-rose-600 dark:text-rose-400">
          snapfeed
        </Link>
        ...
        {sp.notice === "check-email" ? (
          <div className="rounded-xl bg-rose-50 p-4 text-center text-sm text-rose-900 dark:bg-rose-950/40 dark:text-rose-100">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-2 rounded-full bg-rose-600 px-6 py-3 text-base font-semibold text-white shadow-sm transition hover:bg-rose-700 active:scale-[0.98]"
          >
            {isSignup ? "가입" : "로그인"}
          </button>
        </form>
          ...
          {isSignup ? (
            <>
              ...
              <Link
                ...
                className="font-medium text-rose-700 underline-offset-4 hover:underline dark:text-rose-300"
              >
                로그인
              </Link>
            </>
