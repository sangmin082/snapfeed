...
export default function TermsPage() {
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-12">
      <Link
        href="/"
        className="text-sm text-pink-700 underline-offset-4 hover:underline dark:text-pink-400"
      >
        ← snapfeed 홈으로
      </Link>
      ...
      <div className="mt-8 flex flex-col gap-8 text-sm leading-relaxed text-gray-700 dark:text-neutral-300">
        ...
        <Section title="제7조 (콘텐츠의 권리)">
          <p>
            ...
            <Link href="/privacy" className="text-pink-700 underline-offset-4 hover:underline dark:text-pink-400">
              개인정보처리방침
            </Link>
            을 따릅니다.
          </p>
        ...
        <Section title="문의">
          <p>
            약관에 관한 문의:{" "}
            <a href={`mailto:${CONTACT_EMAIL}`} className="text-pink-700 underline-offset-4 hover:underline dark:text-pink-400">
              {CONTACT_EMAIL}
            </a>
          </p>
        </Section>
