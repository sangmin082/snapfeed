  ...
  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-6 px-4 pt-4 pb-10">
      <header className="relative flex h-10 items-center justify-center">
        ...
        <Link
          href="/records"
          className="absolute right-0 inline-flex h-10 items-center px-2 text-sm font-medium text-rose-600 hover:text-rose-700 dark:text-rose-400 dark:hover:text-rose-300"
        >
          기록 보기
        </Link>
      </header>
