      ...
      <div className="flex flex-col gap-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
        ...
        {invalid ? (
          ...
          <form action={acceptInvite} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="rounded-full bg-amber-600 px-6 py-3 text-base font-semibold text-white shadow-sm transition hover:bg-amber-700 active:scale-[0.98]"
            >
              수락하고 가족으로 참여
            </button>
          ...
          <Link
            ...
            className="rounded-full bg-amber-600 px-6 py-3 text-center text-base font-semibold text-white shadow-sm transition hover:bg-amber-700 active:scale-[0.98]"
          >
            로그인하고 수락하기
          </Link>
        )}
