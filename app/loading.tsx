      ...
      <section className="bg-emerald-600/5 dark:bg-emerald-900/10">
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-4 px-6 py-6">
          <div className="flex items-center gap-4">
            <div className="h-14 w-14 animate-pulse rounded-full bg-emerald-100 dark:bg-emerald-900/40" />
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-50 via-white to-white dark:from-emerald-950/40 dark:via-neutral-950 dark:to-neutral-950">
        <div className="mx-auto max-w-2xl px-6 pt-12 pb-14 sm:pt-20 sm:pb-20">
          <div className="flex flex-col items-center gap-6">
            <div className="h-6 w-48 animate-pulse rounded-full bg-emerald-100 dark:bg-emerald-900/40" />
            ...
            <div className="mt-4 flex w-full flex-col gap-3 sm:flex-row sm:justify-center">
              <div className="h-14 w-full animate-pulse rounded-full bg-emerald-200 dark:bg-emerald-900/40 sm:w-44" />
