    ...
    <label className="flex flex-col gap-1 text-sm text-gray-700 dark:text-neutral-300">
      ...
      <div className="flex flex-col gap-2">
        <select
          ...
          className="rounded-lg border border-gray-300 bg-white px-3 py-3 text-base text-gray-900 focus:border-amber-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100"
        >
