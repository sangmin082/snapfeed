  ...
  return (
    <div className="flex flex-col gap-4">
      {previewUrl ? (
        <section className="flex flex-col gap-2">
          ...
          <button
            ...
            className="group relative block overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 transition hover:border-amber-300 dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-amber-700"
            aria-label="사진 크게 보기"
          >
      ...
      <button
        ...
        className="rounded-xl bg-amber-600 px-6 py-3 font-medium text-white disabled:opacity-50"
      >
