/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 61c1da38a632c980209f00fe4301d2cd)
// Runtime types generated with workerd@1.20260415.1 2026-04-01 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "GCP_SA_KEY_JSON" | "ANTHROPIC_API_KEY">> {}
}
